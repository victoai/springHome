...
public class ApiExplorer2 {
    public String getDatas() throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("searchDate","UTF-8") + "=" + URLEncoder.encode("2023-05-08", "UTF-8")); /*통보시간 검색(조회 날짜 입력이 없을 경우 한달동안 예보통보 발령 날짜의 리스트 정보를 확인)*/
    ...
    public ArrayList<DataDto> getDataList(String result) {
    	...
    	for(int i=0; i <items.length(); i++) {
    		...
    		System.out.println("test1.:"+itemJson.getString("informGrade"));
    		System.out.println("test2.:"+itemJson.getString("informCause"));
    		System.out.println("test3.:"+itemJson.getString("dataTime"));
